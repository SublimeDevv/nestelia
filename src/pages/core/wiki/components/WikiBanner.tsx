...
export default function WikiBanner({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col md:flex-row gap-3 md:gap-3 p-4 sm:p-6 md:p-8 items-center">
        <div className="relative flex items-center justify-center md:justify-start shrink-0">
          ...
          >
            ...
            <motion.img
              ...
              className="relative w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 object-contain drop-shadow-2xl"
              animate={{
                y: [0, -10, 0],
              }}
              transition={{
            ...
            <motion.div
              className="absolute top-6 -left-4 sm:top-10 sm:-left-6"
              animate={{
                rotate: [0, 15, 0],
                y: [0, -5, 0],
              }}
            ...
            >
              <Book className="w-6 h-6 sm:w-10 sm:h-10 text-purple-400" />
            </motion.div>
            <motion.div
              className="absolute bottom-12 -right-2 sm:bottom-20 sm:-right-4"
              animate={{
                rotate: [0, -15, 0],
                y: [0, 5, 0],
              }}
        ...
        <div className="flex flex-col justify-center space-y-2 sm:space-y-4 flex-1 w-full">
          <div className="flex items-center gap-2 sm:gap-3 justify-center md:justify-start">
            <BookOpen className="w-8 h-8 sm:w-12 sm:h-12 text-purple-400" />
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white flex items-center gap-2">
              Wiki de{" "}
              <img 
                src={logoNestelia} 
                alt="N" 
                className="inline-block h-10 sm:h-16 md:h-20 w-auto"
              />
          ...
          <div className="space-y-2 sm:space-y-3 text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 pt-2 justify-center md:justify-start">
              <div className="flex items-center gap-2 bg-black/30 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-lg border border-purple-500/20">
              ...
              <div className="flex items-center gap-2 bg-black/30 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-lg border border-purple-500/20">
                ...
                <div>
                  ...
                  <p className="text-base sm:text-lg font-bold text-white">Hoy</p>
                </div>
              </div>
            </div>
          </div>
