        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Una aventura épica de pixel art donde la creatividad y la acción
              se encuentran. Únete a miles de jugadores en un mundo lleno de
          ...
          {/* Community */}
          <div className="space-y-4">
            <h4 className="text-white font-semibold text-lg">Comunidad</h4>
            <ul className="space-y-2">
              {[
                { name: "Discord", href: "#" },
                { name: "Wiki", href: "#" },
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <motion.a
                  ...
                  className="w-9 h-9 bg-gray-800/50 hover:bg-purple-600/20 border border-gray-700 hover:border-purple-500/50 rounded-lg flex items-center justify-center transition-all group"
                  aria-label="YouTube"
                >
                  <svg
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              &copy; {yearFooter} Nestelia. Todos los derechos reservados.
            </p>
            <div className="flex items-center gap-4">
              <a
                href="mailto:contact@nestelia.net"
                className="flex items-center gap-2 text-gray-400 hover:text-purple-400 transition-colors text-sm"
              >
                <Mail className="w-4 h-4" />
                contact@nestelia.net
              </a>
            </div>
          </div>
        </div>
